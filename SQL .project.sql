...
--sum of invoice totals.Returns both the city name and sum of all invoice total?
...
--Q7:Let's invite the artists who have written the most rock music in our dataset.write a guery
...
--the name and milliseconds for each track.Order by the song lenth with the longest songs listed 
--first.
